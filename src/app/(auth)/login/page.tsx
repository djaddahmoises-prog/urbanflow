      ...
      <FadeInView className="w-full max-w-md">
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-lg p-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 mb-2">
            ...
            <p className="text-sm text-neutral-500">Inicia sesión en tu cuenta de UrbanFlow</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-neutral-500 bg-white px-3">o</div>
          </div>

          <Button type="button" variant="outline" size="lg" className="w-full" aria-label="Continuar con Google">
